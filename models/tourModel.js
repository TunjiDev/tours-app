...
const tourSchema = new Schema({
    ...
    guides: [//this guides field only contains the reference to another model(user in this case). 
        {//Effectively creating a relationship between the two datasets
...
tourSchema.pre('save', function(next) {
    ...
    next(); //'this' is the currently processed document
});
